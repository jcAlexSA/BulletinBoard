...
namespace BulletinBoard.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            user.Age = 12;
            user.LastName = "asaasd";
            user.Gender = "male";
            user.Password = "123";
            user.RepeatPassword = "123";
            user.Phone = "11111";
            user.Email = "ashurbin@gmail.com";
            ...
            var config = new MapperConfiguration(cfg => cfg.CreateMap<CreateUserRequest, UserDto>()
                ...
                .ForMember(ud => ud.LastName, opt => opt.MapFrom(cur => cur.LastName))
            ...
            return View("Registration");    // TODO : change user id
        }
    }
}